...
public class PersonalInfoTests {
	...
	public void submitFullApplication() throws InterruptedException {
		...
		country = driver.findElement(By.xpath("//select[@id='Address_Country']/option[" + (indexOfCountry + 1) + "]"))
				.getText();
		...
		assertTrue(driver.findElement(By.xpath("//div[@class='infoContainer']//div[1]")).getText().toLowerCase()
				.contains((firstName + " " + lastName).toLowerCase()));
